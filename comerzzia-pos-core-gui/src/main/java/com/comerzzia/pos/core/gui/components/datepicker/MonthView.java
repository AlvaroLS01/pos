...
final class MonthView extends DatePane {
	...
	public static final String CSS_CALENDAR_MONTH_VIEW = "calendar-month-view";
    public static final String CSS_CALENDAR_DAY_CURRENT_MONTH = "calendar-cell-current-month";
    public static final String CSS_CALENDAR_DAY_OTHER_MONTH = "calendar-cell-other-month";
    public static final String CSS_CALENDAR_TODAY = "calendar-cell-today";
    public static final String CSS_CALENDAR_WEEKDAYS = "calendar-weekdays";
    public static final String CSS_CALENDAR_WEEK_NUMBER = "calendar-week-number";
    public static final String CSS_CALENDAR_SELECTED_DAY = "selected-date";
                    ...
                    public void handle(ActionEvent actionEvent) {
                        ...
                        for(Node node : getChildren()) {
                        	if(node instanceof Button) {
                        		((Button) node).getStyleClass().remove(CSS_CALENDAR_SELECTED_DAY);
                        	}
                        }
                        button.getStyleClass().add(CSS_CALENDAR_SELECTED_DAY);
                    }
                });
    ...
    public void refrescarFecha() {
    	for(Node node : getChildren()) {
        	if(node instanceof Button) {
        		try {
        			((Button) node).getStyleClass().remove(CSS_CALENDAR_SELECTED_DAY);
	        		Date fechaBoton = (Date) ((Button) node).getUserData();
	        		Date fechaSeleccionado = calendarView.getCalendar().getTime();
	        		Calendar cal1 = Calendar.getInstance();
	        		Calendar cal2 = Calendar.getInstance();
	        		cal1.setTime(fechaBoton);
	        		cal2.setTime(fechaSeleccionado);
	        		boolean sameDay = cal1.get(Calendar.YEAR) == cal2.get(Calendar.YEAR) &&
	        		                  cal1.get(Calendar.DAY_OF_YEAR) == cal2.get(Calendar.DAY_OF_YEAR);
	        		if(sameDay) {
	        			((Button) node).getStyleClass().add(CSS_CALENDAR_SELECTED_DAY);
	        		}
        		}
        		catch(Exception e) {
