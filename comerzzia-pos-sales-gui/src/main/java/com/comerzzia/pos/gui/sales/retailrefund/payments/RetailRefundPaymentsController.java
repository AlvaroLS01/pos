package com.comerzzia.pos.gui.sales.retailrefund.payments;
...
@Controller
@CzzScene
public class RetailRefundPaymentsController extends RefundPaymentsControllerAbstract<RetailRefundBasketManager> {
