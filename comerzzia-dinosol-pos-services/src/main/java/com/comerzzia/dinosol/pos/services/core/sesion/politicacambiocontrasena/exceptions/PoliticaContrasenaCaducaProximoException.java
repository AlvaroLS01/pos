...
public class PoliticaContrasenaCaducaProximoException extends UsuarioInvalidLoginException {
	...
	public PoliticaContrasenaCaducaProximoException() {
		super();
	}

	public PoliticaContrasenaCaducaProximoException(String msg) {
		super(msg);
	}

	public PoliticaContrasenaCaducaProximoException(String msg, Throwable e) {
		super(msg, e);
	}
