...
public class PoliticaContrasenaCaducadaException extends UsuarioInvalidLoginException {
	...
	public PoliticaContrasenaCaducadaException() {
		super();
	}

	public PoliticaContrasenaCaducadaException(String msg) {
		super(msg);
	}

	public PoliticaContrasenaCaducadaException(String msg, Throwable e) {
		super(msg, e);
	}
