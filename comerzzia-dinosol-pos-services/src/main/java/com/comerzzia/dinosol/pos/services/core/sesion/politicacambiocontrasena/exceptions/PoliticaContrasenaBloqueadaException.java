...
public class PoliticaContrasenaBloqueadaException extends UsuarioInvalidLoginException {
	...
	public PoliticaContrasenaBloqueadaException() {
		super();
	}

	public PoliticaContrasenaBloqueadaException(String msg) {
		super(msg);
	}

	public PoliticaContrasenaBloqueadaException(String msg, Throwable e) {
		super(msg, e);
	}
