...
public class TestNIP {
	
	public static void main(String[] args) {
		TestNIP test = new TestNIP();
//		Boolean resultado = test.validate("MP4608412");
		
		String nip = test.generate();
		Boolean resultado = test.validate(nip);

		System.out.println("******************* --> " + resultado);
	}

	private static int departmentCodes[] = {
	...
	public String generate() {
		...
		do {
			nip = "";
			nip += String.valueOf(getRandomDepartmentCode());
			nip += String.valueOf(randomNum);
			nip += String.valueOf(calculateControlNumber(nip));
		}
		while (calculateControlNumber(nip) == 10);
	...
	private int getRandomDepartmentCode() {
		int randomNum = ThreadLocalRandom.current().nextInt(0, departmentCodes.length - 1);
		int result = departmentCodes[randomNum];
		return result;
	}
}
