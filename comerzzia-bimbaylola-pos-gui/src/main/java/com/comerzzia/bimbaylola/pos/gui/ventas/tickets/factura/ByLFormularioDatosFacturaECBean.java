...
@Component
@Scope("prototype")
public class ByLFormularioDatosFacturaECBean extends FormularioGui{

	@NotEmpty(message = "Debe introducir un email para continuar.")
    ...
    @NotEmpty(message = "Debe introducir el país para continuar.")
    private String pais;
