...
public class TaxRegistration__1 {
    ...
    private List<NexusOverride__1> nexusOverrides = null;
    @JsonProperty("physicalLocations")
    private List<PhysicalLocation__1> physicalLocations = null;
    @JsonProperty("taxRegistrationNumber")
    private String taxRegistrationNumber;
    @JsonProperty("filingCurrency")
    private FilingCurrency__1 filingCurrency;
    ...
    @JsonProperty("impositionType")
    public ImpositionType__3 getImpositionType() {
        return impositionType;
    }

    @JsonProperty("impositionType")
    public void setImpositionType(ImpositionType__3 impositionType) {
    ...
    @JsonProperty("nexusOverrides")
    public List<NexusOverride__1> getNexusOverrides() {
        return nexusOverrides;
    }

    @JsonProperty("nexusOverrides")
    public void setNexusOverrides(List<NexusOverride__1> nexusOverrides) {
        this.nexusOverrides = nexusOverrides;
    }

    @JsonProperty("physicalLocations")
    public List<PhysicalLocation__1> getPhysicalLocations() {
        return physicalLocations;
    }

    @JsonProperty("physicalLocations")
    public void setPhysicalLocations(List<PhysicalLocation__1> physicalLocations) {
    ...
    @JsonProperty("filingCurrency")
    public FilingCurrency__1 getFilingCurrency() {
        return filingCurrency;
    }

    @JsonProperty("filingCurrency")
    public void setFilingCurrency(FilingCurrency__1 filingCurrency) {
