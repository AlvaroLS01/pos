...
public class PhysicalOrigin__1 {
    ...
    private CurrencyConversion__7 currencyConversion;
    ...
    @JsonProperty("currencyConversion")
    public CurrencyConversion__7 getCurrencyConversion() {
        return currencyConversion;
    }

    @JsonProperty("currencyConversion")
    public void setCurrencyConversion(CurrencyConversion__7 currencyConversion) {
