...
import com.comerzzia.bimbaylola.pos.gui.ventas.tickets.factura.ByLFormularioDatosFacturaCOBean;
...
@Component
public class ByLCambiarDatosClienteCOController extends WindowController {
	...
	protected ByLFormularioDatosFacturaCOBean formulario;
	...
	public void initialize(URL url, ResourceBundle rb) {
		formulario = SpringContext.getBean(ByLFormularioDatosFacturaCOBean.class);
	...
	public void initializeComponents() throws InitializeGuiException {
		...
		tfCodPais.focusedProperty().addListener(new ChangeListener<Boolean>(){
			...
			public void changed(ObservableValue<? extends Boolean> ov, Boolean oldValue, Boolean newValue) {
				...
				if (oldValue && !codPais.equals(ByLCambiarDatosClienteCOController.this.codPais)) {
					...
					ByLCambiarDatosClienteCOController.this.codPais = codPais.toUpperCase();
				}
			}
		});
	...
	protected boolean validarFormulario() {
		...
		final Set<ConstraintViolation<ByLFormularioDatosFacturaCOBean>> constraintViolations = ValidationUI.getInstance().getValidator().validate(formulario);
		Iterator<ConstraintViolation<ByLFormularioDatosFacturaCOBean>> iterator = constraintViolations.iterator();
		while (iterator.hasNext()) {
			final ConstraintViolation<ByLFormularioDatosFacturaCOBean> next = iterator.next();
