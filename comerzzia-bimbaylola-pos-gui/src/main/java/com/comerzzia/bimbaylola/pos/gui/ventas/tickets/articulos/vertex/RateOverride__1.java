...
public class RateOverride__1 {

    @JsonProperty("impositionType")
    private ImpositionType__11 impositionType;
    ...
    @JsonProperty("impositionType")
    public ImpositionType__11 getImpositionType() {
        return impositionType;
    }

    @JsonProperty("impositionType")
    public void setImpositionType(ImpositionType__11 impositionType) {
