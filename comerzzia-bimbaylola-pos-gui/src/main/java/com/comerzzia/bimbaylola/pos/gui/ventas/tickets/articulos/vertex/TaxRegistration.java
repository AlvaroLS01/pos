...
public class TaxRegistration {
    ...
    private FilingCurrency filingCurrency;
    ...
    @JsonProperty("nexusOverrides")
    public void setNexusOverrides(List<NexusOverride> nexusOverrides) {
    ...
    @JsonProperty("filingCurrency")
    public FilingCurrency getFilingCurrency() {
        return filingCurrency;
    }

    @JsonProperty("filingCurrency")
    public void setFilingCurrency(FilingCurrency filingCurrency) {
