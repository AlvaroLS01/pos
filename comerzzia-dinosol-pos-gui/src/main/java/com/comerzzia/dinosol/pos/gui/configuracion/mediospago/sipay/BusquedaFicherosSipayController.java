package com.comerzzia.dinosol.pos.gui.configuracion.mediospago.sipay;
...
public class BusquedaFicherosSipayController extends Controller {
	...
	public void initializeForm() throws InitializeGuiException {
		lbTitulo.setText("");
		tfRutaFichero.setText("/etc/sipayplus/settings/lane3600_prod.txt");
	...
	public class CargarFicheroConfiguracion extends BackgroundTask<Void> {
		...
		protected void failed() {
			...
			log.error("failed() - Error al cargar fichero: " + ex.getMessage(), ex);
