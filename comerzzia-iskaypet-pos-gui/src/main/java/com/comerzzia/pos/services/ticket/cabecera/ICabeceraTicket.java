...
public interface ICabeceraTicket<S extends ISubtotalIvaTicket,T extends ITotalesTicket<?>> {
	...
	public abstract void setTotales(T totales);
	 ...
	 */
	public abstract void setParametrosTicketAparcado();
