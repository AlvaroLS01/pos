...
public class ClientesService {
	...
	public int salvar(ResponseGetClienteRest res) throws ClientesServiceException, ClienteConstraintViolationException {
	...
	public int modificar(ClienteBean cliente) throws ClientesServiceException {
        ...
        try {
			...
			try{
				...
				log.warn("No se ha podido cerrar sesión", e);
			}
        }
	}
