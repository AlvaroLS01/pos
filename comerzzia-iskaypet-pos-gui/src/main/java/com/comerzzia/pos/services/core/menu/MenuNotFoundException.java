...
public class MenuNotFoundException  extends com.comerzzia.pos.util.exception.Exception{
    ...
    public String getMessageDefault() {
    	return I18N.getTexto("El menú consultado no se encuentra en el sistema");
    }
}
