...
public class FiltroLineasPromocion {
	...
	protected DocumentoPromocionable documento;
	...
	public FiltroLineasPromocion(DocumentoPromocionable documento) {
		this.documento = documento;
		filtrarPromoExclusivas = false;
	}

	public void setDocumento(DocumentoPromocionable documento) {
		this.documento = documento;
	}
	...
	protected boolean aplicaRegla(ItemComponentePromoBean regla, LineaDocumentoPromocionable linea) {
		ArticuloBean articuloLinea = linea.getArticulo();
		switch (regla.getItem()) {
			...
			case ItemComponentePromoBean.ITEM_ETIQUETAS:
				return (regla.isOperacionEqual() && containsEtiqueta(articuloLinea.getEtiquetas(), regla.getValor()) || regla.isOperacionNoEqual()
				        && !containsEtiqueta(articuloLinea.getEtiquetas(), regla.getValor()));
