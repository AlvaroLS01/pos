...
public class PaisService {
    ...
    protected static final Logger log = Logger.getLogger(PaisService.class);
    ...
    public List<PaisBean> consultarPais(String codPais, String descPais) throws PaisNotFoundException, PaisServiceException{
        ...
        try{
            ...
            criteriaPais.andUidInstanciaEqualTo(sesion.getAplicacion().getUidInstancia()).andActivoEqualTo(Boolean.TRUE);            
