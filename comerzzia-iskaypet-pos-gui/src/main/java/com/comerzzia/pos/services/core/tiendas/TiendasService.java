...
public class TiendasService {
     ...
     */
    public Tienda consultarTienda(String codAlmacen) throws TiendaNotFoundException, TiendasServiceException {
        String uidActividad = sesion.getAplicacion().getUidActividad();
        return consultarTienda(uidActividad, codAlmacen);
    }
        ...
        try {
            ...
            if (tiendaBean != null) {
                if (tiendaBean.getActivo()) {
                    ...
                    log.debug("consultarTienda() - consultando almacen cond codAlmacen " + codAlmacen);
