...
public class ArticuloNotFoundException extends com.comerzzia.pos.util.exception.Exception{
    ...
    public String getMessageDefault() {
    	return I18N.getTexto("El artículo consultado no se encuentra en el sistema");
    }
