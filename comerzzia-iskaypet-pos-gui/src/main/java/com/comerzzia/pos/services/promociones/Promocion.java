...
public abstract class Promocion implements PromocionTipoAplicacion {
	...
	public void init(PromocionBean promocionBean) throws XMLDocumentException {
	...
	public boolean isAplicable(DocumentoPromocionable documento) {
	...
	protected boolean isAplicaGrupo(GrupoComponentePromoBean grupo, DocumentoPromocionable documento) {
		boolean aplica = false;
		if (grupo.isAndNexo()) {
			aplica = true;
		}
	...
	protected boolean isAplicaRegla(ItemComponentePromoBean regla, DocumentoPromocionable documento) {
	...
	protected boolean comprobarReglaImporteTotal(ItemComponentePromoBean regla, DocumentoPromocionable documento) {
	...
	public abstract boolean aplicarPromocion(DocumentoPromocionable documento);
