...
public class ServicioConfigContadoresParametros {
	...
	public Map<String, ConfigContadorParametroBean> consultarMap(SqlSession sqlSession, String idContador) throws ConfigContadoresParametrosException {

		try {
			return consultarMap(idContador);
		}
		catch (Exception e) {
			log.error("consultar() - " + e.getMessage());
