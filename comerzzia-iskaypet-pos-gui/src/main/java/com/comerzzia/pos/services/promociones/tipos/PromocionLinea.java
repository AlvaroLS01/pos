...
public abstract class PromocionLinea extends Promocion {
     ...
     * @param documento
     */
    public abstract void analizarLineasAplicables(DocumentoPromocionable documento); 
     ...
     * @param lineasAplicables
     */
    public abstract void aplicarPromocion(DocumentoPromocionable documento, LineasAplicablesPromoBean lineasCondicion, LineasAplicablesPromoBean lineasAplicables);
