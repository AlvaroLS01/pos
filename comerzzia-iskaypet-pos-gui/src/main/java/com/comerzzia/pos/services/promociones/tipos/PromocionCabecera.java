...
public abstract class PromocionCabecera extends Promocion {
	...
	protected PromocionTicket getPromocionTipo(DocumentoPromocionable documento, Long idTipoPromocion) {
    	for (PromocionTicket promocion : documento.getPromociones()) {
