...
@XmlType(propOrder = { "codMedioPago", "paymentId", "desMedioPago", "importe", "datosRespuestaPagoTarjeta", "giftcards", "extendedData", "eliminable", "introducidoPorCajero", "movimientoCajaInsertado" })
@Component
@Scope("prototype")
public class PagoTicket implements IPagoTicket {
	...
	public boolean isMedioPagoDefecto() {
		return MediosPagosService.medioPagoDefecto.equals(medioPago);
	}
