...
public class PromocionGeneracionCuponesBean extends PromocionCabecera {
    ...
    public boolean aplicarPromocion(DocumentoPromocionable documento) {
        try {
            ...
            for(int i =0;i<lineasAplicables.getNumCombos();i++){
                ...
                Integer index = SpringContext.getBean(SesionPromociones.class).getIndexCuponPromocion(getIdPromocion());
    ...
    protected void iteraIndiceAleatorio(Integer index) {
    	if(index+1<impresionAleatoria){
    		...
    		SpringContext.getBean(SesionPromociones.class).addCuponPromocion(getIdPromocion());
    	}else{
    		// Borramos histórico de generación de cupones de esta promoción
        	SpringContext.getBean(SesionPromociones.class).resetCuponPromocion(getIdPromocion());
    ...
    public CuponEmitidoTicket generaCupon(DocumentoPromocionable documento) throws CuponesServiceException {
		...
		cupon.setFechaFin(this.getFechaFin());
    ...
    protected GeneratedCouponDto generaCodigoCupon(DocumentoPromocionable documento) throws CuponesServiceException {
