...
public class MenuServiceException extends com.comerzzia.pos.util.exception.Exception{
    ...
    public String getMessageDefault() {
    	return I18N.getTexto("Error realizando consulta de menú en el sistema");
    }
}
