...
@Component
public class CambiarDatosClienteApartadoView extends ModalView{

	@Override
	public Object loadCustomController(){
    	return new CambiarDatosClienteApartadoController();
    }

	@Override
	protected String getFXMLName() {
		return getFXMLName(CambiarDatosClienteView.class);
	}
}
