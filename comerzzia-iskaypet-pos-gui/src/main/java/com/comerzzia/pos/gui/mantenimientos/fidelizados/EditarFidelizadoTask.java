...
@Component
@Scope("prototype")
public class EditarFidelizadoTask extends RestBackgroundTask<FidelizadoBean>{
	
	FidelizadoRequestRest fidelizadoRequest;
	
	public EditarFidelizadoTask(FidelizadoRequestRest fidelizadoRequest, Callback<FidelizadoBean> callback, Stage stage) {
	...
	protected FidelizadoBean call() throws Exception {
		...
		return FidelizadosRest.updateFidelizado(fidelizadoRequest);
	}
