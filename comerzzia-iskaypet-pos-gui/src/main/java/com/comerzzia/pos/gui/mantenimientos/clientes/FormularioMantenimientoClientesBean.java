...
@Component
@Scope("prototype")
public class FormularioMantenimientoClientesBean extends FormularioGui {
    ...
    public FormularioMantenimientoClientesBean() {}
    ...
    public String getIdTratImpuesto() {
        return idTratImpuesto;
    }

    public void setIdTratImpuesto(String idTratImpuesto) {
        this.idTratImpuesto = idTratImpuesto;
    }

    public void setTelefono2(String tlf) {
        this.telefono2 = tlf;
    }
