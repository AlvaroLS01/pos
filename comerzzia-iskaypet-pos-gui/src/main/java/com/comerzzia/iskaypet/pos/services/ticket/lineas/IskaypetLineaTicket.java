...
public class IskaypetLineaTicket extends LineaTicket {
    ...
    @XmlElement(name = "importe_pisado")
    private BigDecimal importePisado;
    ...
    public BigDecimal getImportePisado() {
        return importePisado;
    }

    public void setImportePisado(BigDecimal importePisado) {
        this.importePisado = importePisado;
    }
}
