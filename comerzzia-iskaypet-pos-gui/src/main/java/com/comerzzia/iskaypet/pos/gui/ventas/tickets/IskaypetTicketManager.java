...
//		// CUPONES COMERZZIA 
    ...
    private void registrarImporteLineaProforma(LineaProformaDTO proformaLinea, IskaypetLineaTicket lineaTicket) {
        ...
        if (importe != null) {
            ...
            BigDecimal importeLinea = lineaTicket.getCantidad().abs().multiply(importe.divide(BigDecimal.valueOf(proformaLinea.getUnidades()), 2, RoundingMode.HALF_UP));
            lineaTicket.setImportePisado(importeLinea);
            lineaTicket.setPrecioTotalSinDto(importeLinea);
    ...
    public void calcularImporteCantidadConvertida(IskaypetLineaTicket lineaTicket, BigDecimal importe, BigDecimal cantidadConvertida) {
        if (lineaTicket != null && importe != null && cantidadConvertida != null) {
            ...
            BigDecimal importeTotal = lineaTicket.getImportePisado() != null ? lineaTicket.getImportePisado() : importe;
            lineaTicket.setPrecioTotalSinDto(cantidadConvertida.abs().multiply(importeTotal).setScale(2, RoundingMode.HALF_UP));
