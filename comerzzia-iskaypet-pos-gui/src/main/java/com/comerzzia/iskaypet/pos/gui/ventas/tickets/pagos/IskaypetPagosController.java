...
public class IskaypetPagosController extends PagosController {
					...
					for (BotonBotoneraComponent boton : lstBotones) {
						...
						if (isDevolucion()) {
							...
							if (esDevolucionSinDocOrigen) {
								...
								if (medioPagoSeleccionado != null && comprobarDevolucionMismoMedio(medioPagoSeleccionado)) {
									boton.setDisable(false);
								}
								...
								if (mediosPagoTicketOrigen.contains(codMedioPago) ||
										(codMedioPago.equals(codMedPagVale) && !comprobarDevolucionMismoMedio(medioPagoSeleccionado))) {
									boton.setDisable(false);
								}
	...
	private boolean comprobarDevolucionMismoMedio(MedioPagoBean medioPagoSeleccionado){
