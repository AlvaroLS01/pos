...
public class AdministrativeOrigin {
    ...
    private CurrencyConversion__4 currencyConversion;
    ...
    @JsonProperty("currencyConversion")
    public CurrencyConversion__4 getCurrencyConversion() {
        return currencyConversion;
    }

    @JsonProperty("currencyConversion")
    public void setCurrencyConversion(CurrencyConversion__4 currencyConversion) {
