...
public class AdministrativeOrigin__1 {
    ...
    private CurrencyConversion__6 currencyConversion;
    ...
    @JsonProperty("currencyConversion")
    public CurrencyConversion__6 getCurrencyConversion() {
        return currencyConversion;
    }

    @JsonProperty("currencyConversion")
    public void setCurrencyConversion(CurrencyConversion__6 currencyConversion) {
