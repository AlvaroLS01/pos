...
public class Destination__1 {
    ...
    private CurrencyConversion__3 currencyConversion;
    ...
    @JsonProperty("currencyConversion")
    public CurrencyConversion__3 getCurrencyConversion() {
        return currencyConversion;
    }

    @JsonProperty("currencyConversion")
    public void setCurrencyConversion(CurrencyConversion__3 currencyConversion) {
