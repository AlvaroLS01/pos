...
public class TaxRegistration__5 {
    ...
    private List<NexusOverride__5> nexusOverrides = null;
    @JsonProperty("physicalLocations")
    private List<PhysicalLocation__5> physicalLocations = null;
    @JsonProperty("taxRegistrationNumber")
    private String taxRegistrationNumber;
    @JsonProperty("filingCurrency")
    private FilingCurrency__5 filingCurrency;
    ...
    @JsonProperty("impositionType")
    public ImpositionType__13 getImpositionType() {
        return impositionType;
    }

    @JsonProperty("impositionType")
    public void setImpositionType(ImpositionType__13 impositionType) {
    ...
    @JsonProperty("nexusOverrides")
    public List<NexusOverride__5> getNexusOverrides() {
        return nexusOverrides;
    }

    @JsonProperty("nexusOverrides")
    public void setNexusOverrides(List<NexusOverride__5> nexusOverrides) {
        this.nexusOverrides = nexusOverrides;
    }

    @JsonProperty("physicalLocations")
    public List<PhysicalLocation__5> getPhysicalLocations() {
        return physicalLocations;
    }

    @JsonProperty("physicalLocations")
    public void setPhysicalLocations(List<PhysicalLocation__5> physicalLocations) {
    ...
    @JsonProperty("filingCurrency")
    public FilingCurrency__5 getFilingCurrency() {
        return filingCurrency;
    }

    @JsonProperty("filingCurrency")
    public void setFilingCurrency(FilingCurrency__5 filingCurrency) {
