...
public class PhysicalOrigin {
    ...
    private CurrencyConversion__5 currencyConversion;
    ...
    @JsonProperty("currencyConversion")
    public CurrencyConversion__5 getCurrencyConversion() {
        return currencyConversion;
    }

    @JsonProperty("currencyConversion")
    public void setCurrencyConversion(CurrencyConversion__5 currencyConversion) {
