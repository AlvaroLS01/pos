...
public class ExemptOverride__1 {

    @JsonProperty("amount")
    private BigDecimal amount;
    @JsonProperty("impositionType")
    private ImpositionType__4 impositionType;
    ...
    @JsonProperty("impositionType")
    public ImpositionType__4 getImpositionType() {
        return impositionType;
    }

    @JsonProperty("impositionType")
    public void setImpositionType(ImpositionType__4 impositionType) {
