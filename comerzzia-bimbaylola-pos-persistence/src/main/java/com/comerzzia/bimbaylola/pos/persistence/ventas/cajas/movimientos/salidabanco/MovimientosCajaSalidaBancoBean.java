package com.comerzzia.bimbaylola.pos.persistence.ventas.cajas.movimientos.salidabanco;
...
public class MovimientosCajaSalidaBancoBean {
	...
	public MovimientosCajaSalidaBancoBean() {
		cargo = BigDecimal.ZERO;
		abono = BigDecimal.ZERO;
	}

	public MovimientosCajaSalidaBancoBean(String uidActividad, String uidDiarioCaja, String codTicket, String uidTicket, String codEmp, String codAlmacen, String codCaja, String codConceptoMov,
