...
public class AdministrativeDestination__1 {
    ...
    private CurrencyConversion__2 currencyConversion;
    ...
    @JsonProperty("currencyConversion")
    public CurrencyConversion__2 getCurrencyConversion() {
        return currencyConversion;
    }

    @JsonProperty("currencyConversion")
    public void setCurrencyConversion(CurrencyConversion__2 currencyConversion) {
