...
public class ProcesarDocumentoFiscalPAException extends com.comerzzia.pos.util.exception.Exception {

	private static final long serialVersionUID = 1L;

	public ProcesarDocumentoFiscalPAException() {
		super();
	}

	public ProcesarDocumentoFiscalPAException(String msg) {
		super(msg);
	}

	public ProcesarDocumentoFiscalPAException(Throwable cause) {
		super(cause);
	}

	public ProcesarDocumentoFiscalPAException(String msg, Throwable e) {
		super(msg, e);
	}

	@Override
	public String getMessageDefault() {
		return I18N.getTexto("Error realizando el procesamiento del identificador fiscal");
	}
}
