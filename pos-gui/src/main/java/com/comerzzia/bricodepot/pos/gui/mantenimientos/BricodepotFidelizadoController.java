...
public class BricodepotFidelizadoController extends FidelizadoController {
	...
	private boolean validaEmail() {
		...
		String errorKey = BricoEmailValidator.getValidationErrorKey(emailIntroducido);
		if (errorKey != null) {
			setErrorCampo(paneDatosGeneralesController.getTfEmail(), I18N.getTexto(errorKey));
			return false;
		}
    ...
    paneDatosGeneralesController.getTfEmail()
        .getStyleClass().remove("error-formulario");
    return true;
}
