...
package com.comerzzia.pos.devices.drivers.escpos.printer;
...
import com.comerzzia.pos.devices.drivers.escpos.ticket.BasicTicketForPrinter;
import com.comerzzia.pos.devices.drivers.escpos.util.ReportUtils;

public class EscPosDevicePrinterPrinter implements EscPosDevicePrinter {

    private static Logger log = Logger.getLogger("com.openbravo.pos.printer.printer.DevicePrinterPrinter");

    protected Component parent;
    /*name of a printer*/
    protected String m_sName;
    /*a ticket to print*/
    protected BasicTicketForPrinter m_ticketcurrent;
    /*system printer*/
...
//    private static final Media media = MediaSizeName.ISO_A4;
    ...
    protected int imageable_width;
    protected int imageable_height;
    protected int imageable_x;
    protected int imageable_y;
     ...
     */
    public EscPosDevicePrinterPrinter(Component parent, String printername, int imageable_x, int imageable_y, int imageable_width, int imageable_height, String mediasizename) {
	 ...
	 */
	public EscPosDevicePrinterPrinter(String printername,//Se ha quitado el component parent.
			int imageable_x, int imageable_y, int imageable_width,
			int imageable_height, String mediasizename) {
    ...
    public void endReceipt() {
        ...
        try {
            ...
            if (ps != null)  {
                ...
                aset.add(new JobName("Prueba" + " - Document", null));
                aset.add(media);

                DocPrintJob printjob = ps.createPrintJob();
                Doc doc = new SimpleDoc(new EscPosPrintableBasicTicket(m_ticketcurrent, imageable_x, imageable_y, imageable_width, imageable_height), DocFlavor.SERVICE_FORMATTED.PRINTABLE, null);

                printjob.print(doc, aset);
            }

        } catch (PrintException ex) {
            log.warning("ERROR DE IMPRESORA");
            ex.printStackTrace();
        }
