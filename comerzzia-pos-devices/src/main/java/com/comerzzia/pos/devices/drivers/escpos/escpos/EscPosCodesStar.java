...
public class EscPosCodesStar extends EscPosCodes {
    ...
    public void printBarcode(EscPosPrinterWritter out, String type, String position, String code) {
        ...
        if (EscPosDevicePrinter.BARCODE_EAN13.equals(type)) {
            ...
            out.write(EscPosDeviceTicket.transNumber(EscPosDeviceTicket.alignBarCode(code,13).substring(0,12)));
