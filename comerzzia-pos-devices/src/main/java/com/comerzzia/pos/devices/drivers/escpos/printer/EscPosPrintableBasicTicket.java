...
import com.comerzzia.pos.devices.drivers.escpos.ticket.BasicTicket;
import com.comerzzia.pos.devices.drivers.escpos.ticket.PrintItem;

public class EscPosPrintableBasicTicket implements Printable {
    ...
    public EscPosPrintableBasicTicket(BasicTicket ticket, int imageable_x, int imageable_y, int imageable_width, int imageable_height) {
        this.ticket = ticket;
