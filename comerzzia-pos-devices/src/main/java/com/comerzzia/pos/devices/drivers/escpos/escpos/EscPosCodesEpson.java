...
public class EscPosCodesEpson extends EscPosCodes {
    ...
    private static final byte[] CHAR_SIZE_CONDENSED = {0x1B, 0x21, 0x05};
    ...
    public byte[] getSizeCondensed() { return CHAR_SIZE_CONDENSED; }
